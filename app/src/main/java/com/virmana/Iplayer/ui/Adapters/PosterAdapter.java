    ...
    @Override
            ...
            case 1:
                ...
                holder.image_view_item_poster_image.setOnClickListener(v -> {
                    ...
                    if (posterList.get(position).getType().equals("movie")) {
                         ...
                         intent = new Intent(activity, MusicActivity.class);
                    }
        ...
        public class PosterHolder extends RecyclerView.ViewHolder {
            ...
            public PosterHolder(View itemView) {
                ...
                this.relative_layout_item_poster_delete = itemView.findViewById(R.id.relative_layout_item_poster_delete);
                this.image_view_item_poster_delete = itemView.findViewById(R.id.image_view_item_poster_delete);
            }
        }
