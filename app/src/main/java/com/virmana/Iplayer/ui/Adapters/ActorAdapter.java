...
import com.virmana.Iplayer.ui.activities.ActorActivity;
...
public class ActorAdapter  extends  RecyclerView.Adapter<ActorAdapter.ActorHolder>{
        ...
        public class ActorHolder extends RecyclerView.ViewHolder {
            ...
            public ActorHolder(View itemView) {
                super(itemView);
                this.circle_image_view_item_actor = itemView.findViewById(R.id.circle_image_view_item_actor);
                this.text_view_item_actor_cast = itemView.findViewById(R.id.text_view_item_actor_cast);
                this.text_view_item_actor_name = itemView.findViewById(R.id.text_view_item_actor_name);
                this.linear_layout_item_actor = itemView.findViewById(R.id.linear_layout_item_actor);
            }
        }
    }
