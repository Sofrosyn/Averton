...
import com.virmana.Iplayer.entity.Slide;
import com.virmana.Iplayer.ui.activities.CategoryActivity;
import com.virmana.Iplayer.ui.activities.ChannelActivity;
import com.virmana.Iplayer.ui.activities.GenreActivity;
import com.virmana.Iplayer.ui.activities.MovieActivity;
import com.virmana.Iplayer.ui.activities.MusicActivity;
...
public class SlideAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        TextView text_view_item_slide_one_title = view.findViewById(R.id.text_view_item_slide_one_title);
        ImageView image_view_item_slide_one = view.findViewById(R.id.image_view_item_slide_one);

        text_view_item_slide_one_title.setText(slideList.get(position).getTitle());

        CardView card_view_item_slide_one = view.findViewById(R.id.card_view_item_slide_one);
            ...
            public void onClick(View v) {
                if (slideList.get(position).getType().equals("1") && slideList.get(position).getUrl()!=null){
                    ...
                    if (slideList.get(position).getPoster().getType().equals("movie")) {
                        ...
                        ActivityOptionsCompat activityOptionsCompat = ActivityOptionsCompat.makeSceneTransitionAnimation(activity, image_view_item_slide_one, "imageMain");
                        Intent in = new Intent(activity, MusicActivity.class);
                        in.putExtra("poster", slideList.get(position).getPoster());
                        activity.startActivity(in, activityOptionsCompat.toBundle());
                    }
