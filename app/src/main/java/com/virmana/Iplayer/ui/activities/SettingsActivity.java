...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void initView() {
        this.text_view_dialog_source_size_text= findViewById(R.id.text_view_dialog_source_size_text);
        this.relative_layout_dialog_source_text_color_picker= findViewById(R.id.relative_layout_dialog_source_text_color_picker);
        this.relative_layout_dialog_source_background_color_picker= findViewById(R.id.relative_layout_dialog_source_background_color_picker);
        this.linear_layout_clea_cache= findViewById(R.id.linear_layout_clea_cache);
        this.text_view_cache_value= findViewById(R.id.text_view_cache_value);
        this.switch_button_notification= findViewById(R.id.switch_button_notification);
        this.switch_button_subtitle= findViewById(R.id.switch_button_subtitle);
        this.text_view_version= findViewById(R.id.text_view_version);
        this.linearLayout_policy_privacy= findViewById(R.id.linearLayout_policy_privacy);
        this.linearLayout_contact_us= findViewById(R.id.linearLayout_contact_us);
        this.linear_layout_hash= findViewById(R.id.linear_layout_hash);
        this.image_view_dialog_source_plus= findViewById(R.id.image_view_dialog_source_plus);
        this.image_view_dialog_source_less= findViewById(R.id.image_view_dialog_source_less);
    }
