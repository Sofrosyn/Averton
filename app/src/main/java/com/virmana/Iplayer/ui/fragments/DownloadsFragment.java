...
import com.virmana.Iplayer.Provider.AndroidWebServer;
import com.virmana.Iplayer.R;
import com.virmana.Iplayer.entity.DownloadItem;
import com.virmana.Iplayer.ui.Adapters.DownloadedAdapter;
...
*/
    ...
    private void initView() {
        this.swipe_refresh_layout_downloads_fragment = view.findViewById(R.id.swipe_refresh_layout_downloads_fragment);
        this.linear_layout_load_downloads_fragment = view.findViewById(R.id.linear_layout_load_downloads_fragment);
        this.image_view_empty_list = view.findViewById(R.id.image_view_empty_list);
        this.recycler_view_downloads_fragment = view.findViewById(R.id.recycler_view_downloads_fragment);
    ...
    public void OnPlay(DownloadItem downloadItem) {
        ...
        if (isConnectedInWifi()) {
            if (!isStarted && startAndroidWebServer(downloadItem.getPath())) {
                ...
                Intent intent1 = new Intent(getActivity(), MoviePlayerActivity.class);
