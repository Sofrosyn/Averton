...
import com.virmana.Iplayer.ui.activities.ActorsActivity;
import com.virmana.Iplayer.ui.activities.GenreActivity;
import com.virmana.Iplayer.ui.activities.HomeActivity;
import com.virmana.Iplayer.ui.activities.MyListActivity;
import com.virmana.Iplayer.ui.activities.TopActivity;
...
public class HomeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private class SlideHolder extends RecyclerView.ViewHolder {
        ...
        public SlideHolder(View itemView) {
            super(itemView);
            this.view_pager_indicator= itemView.findViewById(R.id.view_pager_indicator);
            this.view_pager_slide= itemView.findViewById(R.id.view_pager_slide);
        }
    }
    ...
    private class ChannelHolder extends RecyclerView.ViewHolder {
        ...
        public ChannelHolder(View itemView) {
            super(itemView);
            this.recycle_view_channels_item= itemView.findViewById(R.id.recycle_view_channels_item);
            this.image_view_item_channel_more= itemView.findViewById(R.id.image_view_item_channel_more);
    ...
    private class ActorHolder extends RecyclerView.ViewHolder {
        ...
        public ActorHolder(View itemView) {
            super(itemView);
            this.recycle_view_actors_item_actors= itemView.findViewById(R.id.recycle_view_actors_item_actors);
            this.image_view_item_actors_more= itemView.findViewById(R.id.image_view_item_actors_more);
        }
    }
    private class GenreHolder extends RecyclerView.ViewHolder {
        ...
        public GenreHolder(View itemView) {
            super(itemView);
            this.recycle_view_posters_item_genre= itemView.findViewById(R.id.recycle_view_posters_item_genre);
            this.text_view_item_genre_title= itemView.findViewById(R.id.text_view_item_genre_title);
            this.image_view_item_genre_more= itemView.findViewById(R.id.image_view_item_genre_more);
        }
    }
