...
/*                downloadedHolder.image_view_item_download_delete.setOnClickListener(v->{
                    ...
                    for (int i = 0; i < my_downloads_list.size(); i++) {
                        if (my_downloads_list.get(i).getId().equals(downloadItemList.get(position).getId()) ) {
                            ...
                            if (file.exists()){
                                com.virmana.Iplayer.Utils.Log.log( "EXISTR");
                                try {
    ...
    public class DownloadedHolder extends RecyclerView.ViewHolder {
        ...
        public DownloadedHolder(@NonNull View itemView) {
            super(itemView);
            this.relative_layout_item_download= itemView.findViewById(R.id.relative_layout_item_download);
            this.image_view_item_download_delete= itemView.findViewById(R.id.image_view_item_download_delete);
            this.image_view_item_download_image= itemView.findViewById(R.id.image_view_item_download_image);
            this.image_view_item_download_play= itemView.findViewById(R.id.image_view_item_download_play);
            this.image_view_item_download_finder= itemView.findViewById(R.id.image_view_item_download_finder);
            this.text_view_item_download_duration= itemView.findViewById(R.id.text_view_item_download_duration);
            this.text_view_item_download_size= itemView.findViewById(R.id.text_view_item_download_size);
            this.text_view_item_download_title= itemView.findViewById(R.id.text_view_item_download_title);
        }
    }
